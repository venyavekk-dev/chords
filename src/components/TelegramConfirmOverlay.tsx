    ...
    <div className="paywall-overlay" role="dialog" aria-modal="true" aria-labelledby="telegram-confirm-title">
      <div className="paywall-hero">
        ...
        <div className="telegram-message">
          ...
          <div className="telegram-message-body">
            ...
            <div className="telegram-bubble">
              Супер! Напиши Вене, что ты оплатил и больше не хочешь видеть это дурацкое окно каждые пять минут.
              И он тебе вышлет.
        ...
        <div className="paywall-actions">
          <button type="button" className="paywall-cta-text" onClick={onDismiss}>Понятно, продолжить</button>
        </div>
      </div>
    </div>
  );
